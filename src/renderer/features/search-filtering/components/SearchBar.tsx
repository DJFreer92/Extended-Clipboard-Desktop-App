		...
		<div className="search-right">
			...
			<div className="dropdown" ref={tagMenuRef}>
				...
				<button
					...
					title={`Filter by tags${
						selectedTags.length ? `: ${selectedTags.slice(0, 5).join(", ")}${selectedTags.length > 5 ? ", …" : ""}` : ""
					}`}
				>
			...
			<div className="dropdown" ref={appMenuRef}>
				...
				<button
					...
					aria-haspopup="listbox"
					title={`Filter by apps${
						selectedApps.length ? `: ${selectedApps.slice(0, 5).join(", ")}${selectedApps.length > 5 ? ", …" : ""}` : ""
					}`}
				>
			...
			>
				<button type="submit" className="icon-button search-btn left" aria-label="Search" title="Search">
