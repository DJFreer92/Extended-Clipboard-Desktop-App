...
export function useTray() {
	...
	const updateTrayClips = useCallback(
		async (clips: ClipModel[]) => {
	...
	const setTraySearchQuery = useCallback(
		async (query: string) => {
	...
	const onTrayRefreshRequest = useCallback(
		(callback: () => void) => {
	...
	const onTrayCopied = useCallback(
