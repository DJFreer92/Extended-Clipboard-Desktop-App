...
export default function HomePage() {
	...
	const { clips, fetchError, loading, countLoading, displayCount, sentinelRef, refreshClips, handleDelete } =
		pagination;
	...
	return (
		<>
			<div className={`search-row ${isFiltered && clips.length === 0 ? "no-results" : ""}`}>
				<RefreshButton onRefresh={() => void refreshClips()} loading={loading} fetchError={fetchError} />
